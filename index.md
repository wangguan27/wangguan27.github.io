...
<div class="main-flex-container" style="display:flex;gap:40px;align-items:flex-start;max-width:900px;margin:32px auto 0 auto;">
	<!-- Left: Profile -->
	<div style="flex:0 0 320px;text-align:center;">
		...
		<div style="margin-bottom:8px;">
			<span style="font-size:2em;font-weight:700;letter-spacing:-1px;">Guan Wang</span>
		</div>
		<div style="font-size:1.2em;margin-bottom:8px;font-family:'KaiTi','STKaiti','楷体',serif;">王冠</div>
		<div style="font-size:1.1em;opacity:0.75;margin-bottom:8px;">Ph.D. Candidate<br>Rotman School of Management<br>University of Toronto</div>
		<div style="font-size:1em;opacity:0.6;margin-bottom:18px;">Toronto, Canada</div>
		<div style="margin-bottom:18px;">
			<a href="mailto:wguan.wang@mail.utoronto.ca" style="text-decoration:none;font-size:1.5em;margin-right:12px;opacity:0.7;" title="Email"><i class="fa-solid fa-envelope"></i></a>
			<a href="https://scholar.google.com/citations?hl=en&user=8EDsEvAAAAAJ" target="_blank" style="text-decoration:none;font-size:1.5em;opacity:0.7;" title="Google Scholar"><i class="ai ai-google-scholar"></i></a>
		</div>
	</div>
	...
	<div style="flex:1;min-width:0;">
		...
		<ol style="font-size:1.08em;line-height:1.8;color:#222;margin-bottom:32px;padding-left:22px;">
			<li style="margin-bottom:20px;">
				...
				<span style="color:#444;">&#9632; Invited presentation at NYC Department of City Planning</span><br>
			...
			<li style="margin-bottom:20px;">
				...
				<span style="color:#444;">&#9632; Accepted for presentation at INFORMS 2026, MSOM 2026, RMP 2026, CORS 2026, POMS 2026, INFORMS 2025, RMP 2025</span><br>
			...
			<li style="margin-bottom:20px;">
				...
				<span style="color:#555;">with <a href="https://arxiv.org/search/stat?searchtype=author&query=Chen,+N" target="_blank" style="color:#1976d2;text-decoration:underline;">Ningyuan Chen</a>, <a href="https://arxiv.org/search/stat?searchtype=author&query=Farajollahzadeh,+S" target="_blank" style="color:#1976d2;text-decoration:underline;">Setareh Farajollahzadeh</a>, <a href="https://arxiv.org/search/stat?searchtype=author&query=Jin,+Q" target="_blank" style="color:#1976d2;text-decoration:underline;">Qingwei Jin</a>, and <a href="https://arxiv.org/search/stat?searchtype=author&query=Shen,+F" target="_blank" style="color:#1976d2;text-decoration:underline;">Fanni Shen</a></span><br>
