...
<div class="main-flex-container" style="display:flex;gap:40px;align-items:flex-start;max-width:900px;margin:32px auto 0 auto;">
	...
	<div style="flex:1;min-width:0;">
		...
		<ul style="font-size:1.08em;line-height:1.7;margin-bottom:32px;">
			<li>04/2026: Welcome to my new academic homepage!</li>
			<!-- <li>03/2026: Paper accepted at ... (update your news here)</li> -->
		</ul>
